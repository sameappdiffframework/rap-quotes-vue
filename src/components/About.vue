<template>
  ...
  <p>
    ...
    SADF aims to recreate the same app using different frameworks (Angular, React, Vue, etc, etc) in order to
    compare and learn each framework.
  </p>

  <p>
    Rap Quotes is the skeleton for that common app in the project.
    It was created here by hand just to work through all the desired CSS and HTML <em>before</em> attempting to
  ...
  <p>
    In order to serve as a good app, this app aims to use the following features that are commonly seen during
    web app development.
  </p>
